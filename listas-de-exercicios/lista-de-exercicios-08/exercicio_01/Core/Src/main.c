...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim){ // led
	HAL_GPIO_TogglePin(LED_GPIO_Port, LED_Pin); // led piscando
}

void HAL_GPIO_EXTI_Rising_Callback(uint16_t GPIO_Pin){ // botão
