...
#define G_10_Pin GPIO_PIN_6
#define G_10_GPIO_Port GPIOA
#define F_9_Pin GPIO_PIN_7
#define F_9_GPIO_Port GPIOA
#define A_7_Pin GPIO_PIN_0
#define A_7_GPIO_Port GPIOB
#define DIP_1_Pin GPIO_PIN_13
#define DIP_1_GPIO_Port GPIOB
#define E_1_Pin GPIO_PIN_14
#define E_1_GPIO_Port GPIOB
#define B_6_Pin GPIO_PIN_7
#define B_6_GPIO_Port GPIOC
#define DIP_3_Pin GPIO_PIN_8
#define DIP_3_GPIO_Port GPIOD
#define DIP_4_Pin GPIO_PIN_9
#define DIP_4_GPIO_Port GPIOD
#define DP_5_Pin GPIO_PIN_3
#define DP_5_GPIO_Port GPIOB
#define D_2_Pin GPIO_PIN_4
#define D_2_GPIO_Port GPIOB
#define C_4_Pin GPIO_PIN_5
